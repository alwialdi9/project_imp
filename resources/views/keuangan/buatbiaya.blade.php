        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="#">Buat Biaya</a></div>
            </div>
          </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select class="form-control select2" id="tag" name="tag" multiple="">
                              <option value="">Kemenag RI</option>
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          ...
                          <input type="text" class="form-control currency" placeholder="Masukkan Total" name="total">
                        </div>
                        </div>
                      </div>
